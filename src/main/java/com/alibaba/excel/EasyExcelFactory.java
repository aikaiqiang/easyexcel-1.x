...
public class EasyExcelFactory {
	...
	/**
	 *
	 * @param in         he POI filesystem that contains the Workbook stream.
	 * @param sheet      read sheet.
	 * @param listener   Callback method after each row is parsed.
	 * @param readLimit  read row sum
	 */
	public static void readBySax(InputStream in, Sheet sheet, AnalysisEventListener listener, Integer readLimit) {
		new ExcelReader(in, readLimit, listener).read(sheet);
	}
